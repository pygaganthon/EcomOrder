...
//    @Spy
    @InjectMocks
    private OrderServiceImpl mokOrdSvc;
...
//    }
    ...
    public void getOrderById() {
        ...
        orderVO.setOrder_id(1L);
        orderVO.setOrder_status(OrderConstants.CREATED.toString());

        Mockito.when(iOrderDAO.findById(1L)).thenReturn(Optional.of(entityOrder));
        Mockito.when(iOrderTranslator.toOrderVO(entityOrder)).thenReturn(orderVO);
        assertEquals(orderVO, mokOrdSvc.getOrderById(1L));
